...
import {
  ...
  ChevronDown, ArrowLeft, Share2, MoreHorizontal, Eye, Users, Copy, QrCode, X,
} from 'lucide-react';
          ...
          <div className="rounded-xl border border-neutral-800 overflow-hidden" style={{ backgroundColor: '#111' }}>
            ...
            <div className="p-2">
              <div
                ...
                style={{ backgroundColor: '#0a0a0a', border: '1px solid #1f1f1f', aspectRatio: '1.586/1' }}
              >
                <div className="w-full h-full p-2 flex flex-col justify-between">
                  <div>
                    <div
                      className="w-5 h-5 rounded-md flex items-center justify-center mb-1"
                      style={{ backgroundColor: '#1a1a1a', border: `1px solid ${GOLD}50` }}
                    >
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5 mt-3">
          ...
          {['Dadrio', 'Nikhil'].map((s) => (
            <span key={s} className="px-2 py-0.5 rounded-full border border-neutral-700 text-[8px] text-neutral-400">
              {s}
            </span>
          ))}
        </div>
      ...
      >
        {['Recording', 'Transcript', 'AI Summary', 'Tasks', 'Notes', 'Ask AI', 'Generate'].map(
          (tab, i) => (
            <button
              key={tab}
      ...
      <div className="flex-1 space-y-3 overflow-hidden">
        <div>
          ...
          <p className="text-neutral-400 text-[10px] leading-relaxed">
            Discussion covered ethical frameworks for AI development — bias mitigation, transparency
            requirements, and responsible deployment strategies for production systems.
          </p>
        </div>
        <div>
          ...
          <div className="p-3">
            ...
            >
              ...
              >
                <div className="flex items-start gap-2.5">
                  <div
                    ...
                    style={{ backgroundColor: '#1a1a1a', border: `1.5px solid ${GOLD}` }}
                  >
              ...
              <div
                ...
                style={{ background: `linear-gradient(90deg, ${GOLD}, ${GOLD}40)` }}
              />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-neutral-500 text-lg leading-relaxed max-w-sm">
              Cards, scheduling, AI transcription, tasks — one tool for your identity and your work.
            </p>
        ...
        <div className="md:hidden px-4 pt-2 pb-16">
          ...
          <div className="overflow-x-auto -mx-4 px-4">
            <div
              ...
              style={{
                minWidth: '400px',
                boxShadow: '0 24px 60px rgba(0,0,0,0.7), 0 8px 24px rgba(0,0,0,0.4)',
              }}
            >
              <div
              ...
              <div className="grid grid-cols-5 gap-16 items-center">
                ...
                <div className="col-span-3">
                  <div
                    className="rounded-2xl overflow-hidden border border-neutral-800"
                    style={{
                      boxShadow: '0 40px 100px rgba(0,0,0,0.8), 0 8px 32px rgba(0,0,0,0.5)',
                    }}
                  >
                    <div
