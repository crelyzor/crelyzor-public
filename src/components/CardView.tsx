...
export function CardView({ data, username, slug }: CardViewProps) {
    ...
    const fontFamily = card.theme?.fontFamily || 'var(--font-inter), Inter, system-ui, sans-serif';

    const handleLinkClick = (link: CardLink) => {
        trackClick(card.id, link.url).catch(() => { });
    };
                                    ...
                                    <div className="relative h-full flex flex-col justify-between p-5 sm:p-6">
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div
                                                ...
                                                style={{ boxShadow: `0 0 0 1.5px ${accent}`, backgroundColor: '#1a1a1a' }}
                                            >
